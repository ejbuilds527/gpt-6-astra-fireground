...
const auth = authkitProxy({
  ...
  middlewareAuth: {
    enabled: true,
    unauthenticatedPaths: ['/', '/signin', '/signout', '/callback', '/api/ai-health', '/how-it-works.html', '/shuttle-map.png', '/theater-map.png', '/dispatch.m4a', '/dispatch-male.m4a', '/dispatch-female.m4a', '/api/ask', '/demo', '/demo/index.html', '/demo/lay-map.png', '/demo/shuttle-map.png', '/demo/theater-map.png'],
  },
});
