...
export function Settings({initial}:{initial:Data}){
 ...
 .settings-fields { color: inherit; }
 .settings-fields input, .settings-fields select, .settings-fields tbody th { color: inherit; }
